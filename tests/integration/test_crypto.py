...
class TestFilenameUploadDownload(BaseTransferManagerIntegTest):
    def setUp(self):
        super(TestFilenameUploadDownload, self).setUp()
...
class KMSTransferManagerIntegTest(TestFilenameUploadDownload):
    def setUp(self):
...
class TestAesWrapWithAesGcmFilenameUpload(TestFilenameUploadDownload):
    def setUp(self):
...
class TestKmsWithAesCbcFilenameUpload(TestAesWrapWithAesGcmFilenameUpload):
    def setUp(self):
...
class TestAesWrapWithAesGcmFilenameDownload(TestFilenameUploadDownload):
    def setUp(self):
...
class TestKmsWithAesCbcFilenameDownload(TestAesWrapWithAesGcmFilenameDownload):
    def setUp(self):
